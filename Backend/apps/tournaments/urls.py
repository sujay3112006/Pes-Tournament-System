...
urlpatterns = [
    ...
    path('<str:tournament_id>/', TournamentDetailView.as_view(), name='tournament_detail'),
    
    # Tournament participation
    path('<str:tournament_id>/join/', JoinTournamentView.as_view(), name='join_tournament'),
    path('<str:tournament_id>/leave/', LeaveTournamentView.as_view(), name='leave_tournament'),
